"""e_tib_ing_cam_16434 URL Configuration
...
admin.site.site_header = "E-TIB Ing Cam"
admin.site.site_title = "E-TIB Ing Cam Admin Portal"
admin.site.index_title = "E-TIB Ing Cam Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="E-TIB Ing Cam API",
        default_version="v1",
        description="API documentation for E-TIB Ing Cam App",
    ),
    public=True,
